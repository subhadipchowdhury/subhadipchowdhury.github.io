...
//
// It briefly held a second table for the arrow notation, while `newton` was
// converted to sentences and `runge` was not. Both are converted now, and
...
const ENTRIES = [
  ...
  [['a * b', 'a - b', 'a / b', 'a ^ b'],
    'multiply, subtract, divide, raise to a power. Every operator here is one you can type, so a blank takes exactly what you read.'],
  [['i != j'],
    'means "i is not equal to j". If you have met a different spelling, /=, <> and ~= all work too.'],
  [['i <= j', 'i >= j'],
    'means "i is at most j" and "i is at least j".'],
  [['i = j'],
    'compares, and only compares. Use let to store a value.'],
  [['π'],
    'and you can type pi in a blank.'],
  [['abs(x)'],
