...
// No lab ships this one any more: it was the Newton lab's middle gate and was
// cut. Kept because nothing else covers this interpreter shape, a nested loop
// whose inner bound shrinks down the rows, a `print` of a two-subscript entry,
// and a blank that names the loop variable it sits in the bound of.
