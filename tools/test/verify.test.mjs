...
import { buildReference, verify, renderTriangle, expressionsAgree } from '../../teaching/applet/lab/engine/verify.js';
import { valuesEqual } from '../../teaching/applet/lab/engine/interp.js';
import {
